...
VALUES
      ('2023-12-25', 2, '2023-12-29', 900.80, 'true', 1, 4),
	  ('2025-10-05', 3, '2025-10-07', 10.80, 'false', 2, 5),
	  ('2022-08-23', 1, '2022-08-30', 520.00, 'true', 3, 6);
	  
INSERT INTO Favorites(Favorites_name, fk_User_Id, fk_Accommodation_Id) 
VALUES
      ('Trip to Sao Paulo', 2, 4),
      ('Next vacation', 1, 5),
      ('Comfortable places', 3, 6);
